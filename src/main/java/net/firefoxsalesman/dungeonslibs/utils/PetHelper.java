...
import static net.firefoxsalesman.dungeonslibs.utils.AbilityHelper.canApplyToEnemy;
...
public class PetHelper {
	...
	public static void makeNearbyPetsAttackTarget(LivingEntity target, LivingEntity owner) {
		...
		List<LivingEntity> nearbyEntities = owner.getCommandSenderWorld().getEntitiesOfClass(LivingEntity.class,
				owner.getBoundingBox().inflate(12), nearbyEntity -> isPetOf(owner, nearbyEntity));
